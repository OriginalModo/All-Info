# Предназначение рекурсии - разбивать/уменьшать поступившие данные до тех пор, пока не будет выоплнено условие выхода.
...
def my_reverse(value: str) -> str:
    ...
    # return value[-1] + my_reverse(value[-2:])
