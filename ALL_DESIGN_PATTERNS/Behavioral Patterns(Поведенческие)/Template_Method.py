...
Суть: позволяет выделить основу алгоритмов в базовый класс и переопределять его некоторые шаги в производных классах
при это не изменяя общей структуры самого алгоритма

В каких случаях рекомендуется использовать:
1) необходимо иметь возможность расширять базовый алгоритм в производных классах, не меняя его структуры
2) необходимо выделить и локализовать в одном классе общее поведение для всех производных классов

Плюсы:
--- уменьшает количество дублируемого кода

Минусы:
--- потеря гибкости из-за наличия жёстких ограничений скелетом реализуемого базового алгоритма
--- сложность поддержки кода с ростом количества шагов в алгоритме
"""
